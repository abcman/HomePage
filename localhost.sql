...
--
-- Хост: localhost
-- Время создания: Апр 02 2015 г., 16:24
...
-- База данных: `catalog`
--
CREATE DATABASE `catalog` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `catalog`;
...
INSERT INTO `org` (`id`, `name`, `category`, `phone`, `adress`) VALUES
(1, '234234', '0', '3242346656', 'ulica pidor'),
(2, '2323', '0', '2323', '2323'),
(3, '4', '0', '4', '4'),
(4, 'Аксайская школа 3', 'Школа', '+756+5', 'Аксай, Чапаева 299'),
(5, 'dwdw', 'wddw', 'dww', 'dwd'),
(6, 'Аксай школа 2', '1', '+79085177059', 'Артем сергеевич');
...
INSERT INTO `users` (`id`, `name`, `passw`, `date`) VALUES
(18, 'user', 'passwwooww', '2015-04-02 10:33:15'),
(17, 'admin', 'ssss', '2015-04-02 10:29:52');
--
...
(NULL, 'catalog', 'category', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'catalog', 'category', 'name', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'org', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'catalog', 'org', 'name', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'org', 'category', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'org', 'phone', 4, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'org', 'adress', 5, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'catalog', 'users', 'name', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'users', 'passw', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
(NULL, 'catalog', 'users', 'date', 4, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', ''),
...
(NULL, 'mysql', 'ndb_binlog_index', 'File', 2, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'cp1251', 'cp1251_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
...
(NULL, 'phpmyadmin', 'pma_history', 'id', 1, NULL, 'NO', 'bigint', NULL, NULL, 20, 0, NULL, NULL, 'bigint(20) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
...
('THREADS_RUNNING', '1'),
('UPTIME', '18959'),
('UPTIME_SINCE_FLUSH_STATUS', '18959');
...
('LICENSE', 'GPL'),
('CHARACTER_SETS_DIR', 'C:\\Winginx\\mysql\\share\\charsets\\'),
('HAVE_CRYPT', 'NO'),
...
('SLOW_LAUNCH_TIME', '2'),
('PID_FILE', 'C:\\Winginx/temp/mysql.pid'),
...
('LOG_OUTPUT', 'FILE'),
('LANGUAGE', 'C:\\Winginx\\mysql\\share\\english\\'),
...
('SQL_LOG_BIN', 'ON'),
('GENERAL_LOG_FILE', 'C:\\Winginx\\temp\\mysql.log'),
('HAVE_GEOMETRY', 'YES'),
('OPEN_FILES_LIMIT', '755'),
('MYISAM_SORT_BUFFER_SIZE', '8388608'),
('AUTO_INCREMENT_INCREMENT', '1'),
('SSL_CERT', ''),
('TMPDIR', 'C:\\Winginx/temp'),
('LOG_BIN', 'OFF'),
('EXPIRE_LOGS_DAYS', '0'),
...
('SLAVE_LOAD_TMPDIR', 'C:\\Winginx\\temp'),
...
('UNIQUE_CHECKS', 'ON'),
('SYSTEM_TIME_ZONE', ''),
('VERSION', '5.1.62-community'),
('SERVER_ID', '1'),
('SOCKET', 'C:\\Winginx/temp/mysql.sock'),
...
('DATADIR', 'C:\\Winginx\\mysql\\data\\'),
('TABLE_DEFINITION_CACHE', '256'),
('SQL_LOG_OFF', 'OFF'),
('PROFILING_HISTORY_SIZE', '15'),
('AUTOCOMMIT', 'ON'),
('BASEDIR', 'C:\\Winginx\\mysql\\'),
...
('SLOW_QUERY_LOG_FILE', 'C:\\Winginx/logs/mysql-slow.log'),
...
('PLUGIN_DIR', 'C:\\Winginx/mysql/lib/plugin'),
('TMP_TABLE_SIZE', '16777216'),
('LOCAL_INFILE', 'ON'),
('LOG_ERROR', 'C:\\Winginx\\logs\\mysql.err'),
('HAVE_RTREE_KEYS', 'YES'),
('REPORT_USER', ''),
...
(NULL, 'catalog', 'PRIMARY', NULL, 'catalog', 'category', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'catalog', 'PRIMARY', NULL, 'catalog', 'org', 'id', 1, NULL, NULL, NULL, NULL),
(NULL, 'catalog', 'PRIMARY', NULL, 'catalog', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
(NULL, 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2679, 0, 16770540, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3545, 0, 16760760, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2015-04-02 12:24:27', NULL, NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2015-04-02 12:24:27', '2015-04-02 12:24:27', NULL, NULL, '', '', NULL),
(NULL, 'catalog', 'category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 25, 76, 281474976710655, 2048, 0, '2015-04-02 07:17:20', '2015-04-02 07:23:00', NULL, NULL, '', '', NULL),
(NULL, 'catalog', 'org', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 51, 308, 281474976710655, 2048, 0, '2015-04-02 08:28:01', '2015-04-02 08:47:06', NULL, NULL, '', '', NULL),
(NULL, 'catalog', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 280, 281474976710655, 2048, 176, '2015-03-31 08:13:06', '2015-04-02 10:38:28', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2009-11-04 13:06:41', '2009-11-04 19:06:42', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 440, 123848989752688639, 5120, 440, '2009-11-04 13:06:42', '2011-11-23 10:53:30', '2009-11-04 13:06:42', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-11-04 13:06:42', '2009-11-04 19:06:42', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2009-11-04 13:06:41', '2009-11-04 19:06:42', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 36, 581, 20916, 163536961468891135, 3072, 0, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:08', NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 395, 197, 77815, 55450570411999231, 13312, 0, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:08', NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 809, 9, 7281, 2533274790395903, 15360, 0, '2007-07-04 13:49:18', '2007-07-04 17:49:20', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 466, 715, 333276, 281474976710655, 15360, 0, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:08', NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2009-11-04 13:06:42', '2009-11-04 19:06:42', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2009-11-04 13:05:09', '2009-11-04 19:05:10', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2009-11-04 13:05:09', '2009-11-04 19:05:10', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-11-04 13:06:42', '2009-11-04 19:06:42', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2009-11-04 13:06:42', '2009-11-04 19:06:42', '2009-11-04 13:06:42', NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2009-11-04 13:05:09', '2009-11-04 19:05:10', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2009-11-04 13:06:41', '2009-11-04 19:06:42', '2009-11-04 13:06:41', NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:09', NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 280, 281474976710655, 2048, 176, '2009-11-04 13:06:42', '2011-11-23 10:53:30', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_bookmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_column_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_history', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2011-11-24 12:12:56', '2011-11-24 18:12:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_pdf_pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_table_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL),
(NULL, 'phpmyadmin', 'pma_table_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, NULL, '', '', NULL);
...
('InnoDB', '1.0', 'DISABLED', 'STORAGE ENGINE', '50162.0', NULL, NULL, 'Innobase OY', 'Supports transactions, row-level locking, and foreign keys', 'GPL'),
...
(134, 'root', 'localhost:63562', 'catalog', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'catalog', 'utf8', 'utf8_general_ci', NULL),
...
('THREADS_RUNNING', '1'),
('UPTIME', '18960'),
('UPTIME_SINCE_FLUSH_STATUS', '18960');
...
(NULL, 'catalog', 'category', 0, 'catalog', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', ''),
(NULL, 'catalog', 'org', 0, 'catalog', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', ''),
(NULL, 'catalog', 'users', 0, 'catalog', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'mysql', 'help_keyword', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', 395, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'help_keyword', 0, 'mysql', 'name', 1, 'name', 'A', 395, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 1, 'help_keyword_id', 'A', NULL, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'help_relation', 0, 'mysql', 'PRIMARY', 2, 'help_topic_id', 'A', 809, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'help_topic', 0, 'mysql', 'PRIMARY', 1, 'help_topic_id', 'A', 466, NULL, NULL, '', 'BTREE', ''),
(NULL, 'mysql', 'help_topic', 0, 'mysql', 'name', 1, 'name', 'A', 466, NULL, NULL, '', 'BTREE', ''),
...
(NULL, 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
(NULL, 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
(NULL, 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
(NULL, 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
(NULL, 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
(NULL, 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
(NULL, 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
(NULL, 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
(NULL, 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
(NULL, 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
(NULL, 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
(NULL, 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
(NULL, 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2679, 0, 16770540, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6262', ''),
(NULL, 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3545, 0, 16760760, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4732', ''),
(NULL, 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
(NULL, 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
(NULL, 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2015-04-02 12:24:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2015-04-02 12:24:29', '2015-04-02 12:24:29', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'catalog', 'category', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 25, 76, 281474976710655, 2048, 0, 4, '2015-04-02 07:17:20', '2015-04-02 07:23:00', NULL, 'utf8_general_ci', NULL, '', ''),
(NULL, 'catalog', 'org', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 51, 308, 281474976710655, 2048, 0, 7, '2015-04-02 08:28:01', '2015-04-02 08:47:06', NULL, 'utf8_general_ci', NULL, '', ''),
(NULL, 'catalog', 'users', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 280, 281474976710655, 2048, 176, 19, '2015-03-31 08:13:06', '2015-04-02 10:38:28', NULL, 'utf8_general_ci', NULL, '', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2009-11-04 13:06:41', '2009-11-04 19:06:42', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 440, 123848989752688639, 5120, 440, NULL, '2009-11-04 13:06:42', '2011-11-23 10:53:30', '2009-11-04 13:06:42', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-11-04 13:06:42', '2009-11-04 19:06:42', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2009-11-04 13:06:41', '2009-11-04 19:06:42', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 36, 581, 20916, 163536961468891135, 3072, 0, NULL, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:08', 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 395, 197, 77815, 55450570411999231, 13312, 0, NULL, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:08', 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 809, 9, 7281, 2533274790395903, 15360, 0, NULL, '2007-07-04 13:49:18', '2007-07-04 17:49:20', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 466, 715, 333276, 281474976710655, 15360, 0, NULL, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:08', 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2009-11-04 13:06:42', '2009-11-04 19:06:42', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2009-11-04 13:05:09', '2009-11-04 19:05:10', NULL, 'cp1251_general_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2009-11-04 13:05:09', '2009-11-04 19:05:10', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-11-04 13:06:42', '2009-11-04 19:06:42', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2009-11-04 13:06:42', '2009-11-04 19:06:42', '2009-11-04 13:06:42', 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2009-11-04 13:05:09', '2009-11-04 19:05:10', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2009-11-04 13:06:41', '2009-11-04 19:06:42', '2009-11-04 13:06:41', 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2007-07-04 13:49:18', '2009-11-04 19:05:08', '2009-11-04 13:05:09', 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2007-07-04 13:49:18', '2007-07-04 17:49:18', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 280, 281474976710655, 2048, 176, NULL, '2009-11-04 13:06:42', '2011-11-23 10:53:30', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
(NULL, 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
(NULL, 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2011-11-24 12:12:56', '2011-11-24 18:12:56', NULL, 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
(NULL, 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'Relation table'),
(NULL, 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
(NULL, 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-11-04 16:46:55', '2009-11-04 22:46:56', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin');
...
(NULL, 'catalog', 'PRIMARY', 'catalog', 'category', 'PRIMARY KEY'),
(NULL, 'catalog', 'PRIMARY', 'catalog', 'org', 'PRIMARY KEY'),
(NULL, 'catalog', 'PRIMARY', 'catalog', 'users', 'PRIMARY KEY'),
...
(24, 'Data Manipulation', 31, ''),
(25, 'Administration', 31, ''),
...
(229, 'CURSOR'),
(230, 'CODE'),
(231, 'GEOMETRYCOLLECTIONFROMTEXT'),
(232, 'CHAIN'),
(233, 'FLUSH'),
(234, 'CREATE'),
(235, 'DESCRIBE'),
(236, 'MAX_UPDATES_PER_HOUR'),
(237, 'INT2'),
(238, 'PROCESSLIST'),
(239, 'LOGS'),
(240, 'HEAP'),
...
(267, 'OR'),
(268, 'IDENTIFIED'),
(269, 'MASTER_SSL_CIPHER'),
(270, 'SQL_SLAVE_SKIP_COUNTER'),
(271, 'BOTH'),
(272, 'BOOL'),
(273, 'YEAR'),
(274, 'MASTER_PORT'),
...
(295, 'LINES'),
(296, 'SQL_THREAD'),
(297, 'MAX_QUERIES_PER_HOUR'),
(298, 'MULTIPOLYGONFROMWKB'),
(299, 'MASTER_SSL_CERT'),
(300, 'DAY_MINUTE'),
(301, 'TRANSACTION'),
(302, 'DATE_SUB'),
...
--
CREATE DATABASE `phpmyadmin` DEFAULT CHARACTER SET cp1251 COLLATE cp1251_general_ci;
USE `phpmyadmin`;
